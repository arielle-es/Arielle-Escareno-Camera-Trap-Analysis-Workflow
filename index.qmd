...
## Background: Santa Fé Island

Santa Fé Island is a small, remote island in the Galápagos Archipelago of Ecuador. It is home to the endemic Galápagos land iguana, but its native tortoise species went extinct in the mid-1800s, largely due to hunting by sailors and whalers passing through the islands at the time.

Because of their extinction, a different but closely related species was introduced starting in 2015 to restore the island's lost ecological balance. Since then, both species have coexisted on the island.
...
![Image Classification GUI](Imagesss/image_class.png){width=50% fig-align="center"}
...
![My classifications viewed as a text file](Imagesss/classificationss.png){width=50% fig-align="center"}
...
- Both species were detected at several of the same camera trap locations, indicating partial overlap rather than complete separation of habitat use. However, species did favor different camera trap sites overall, leading me to reject my "Overlap hypothesis"
- Although tortoises and iguanas were rarely photographed together, they were active during similar times of day; this appears to be because they were present at different camera trap sites during differing time periods
- This suggests the two species are not avoiding each other by being active at different times overall, so my "Avoidance hypothesis" is not fully supported either, the data instead suggests avoidance is happening at the site level
